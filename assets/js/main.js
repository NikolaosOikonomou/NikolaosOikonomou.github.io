...
(function ($) {
	classesArray = ['popup-content-RecipesBook', 'popup-content-ColorsTNC', 'popup-content-Hollywoodland', 'popup-content-AngularApp', 'popup-content-WeatherApp']
	const removeClasses = () => {
	...
	// ===================  Start Recipes Book ====================================
	// Login Page
	$("#recipesBookLogin").on("click", function () {
		let imgUrl = $(this).attr('value');

		removeClasses();
		$(".popup, .popup-content-RecipesBook").addClass("active");
		$('.demoImgDimentions').attr('src', imgUrl);
	});

	$("#closeRecipesBook").on("click", function () {
		$(".popup, .popup-content-RecipesBook").removeClass("active");
	});

	// Recipes Page
	$("#recipesBookPage").on("click", function () {
		let imgUrl = $(this).attr('value');
	...
	// Create Recipe Page
	$("#recipesBookCreate").on("click", function () {
		let imgUrl = $(this).attr('value');
	...
	// Edit Recipe Page
	$("#recipesBookEdit").on("click", function () {
		let imgUrl = $(this).attr('value');
	...
	// Shopping List Page
	$("#recipesBookShoppingL").on("click", function () {
		let imgUrl = $(this).attr('value');
